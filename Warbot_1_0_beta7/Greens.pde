...
class GreenBase extends Base {
  ...
  GreenBase(PVector p, color c, Team t, int no) {
    ...
    if (no == 1)
      ...
      setPosition(new PVector(2 * game.w2 / 3, game.h2, 0));
  }
...
///////////////////////////////////////////////////////////////////////////
class GreenExplorer extends Explorer {
  //
  // constructor
  // ===========
  //
...
///////////////////////////////////////////////////////////////////////////
class GreenHarvester extends Harvester {
  //
  // constructor
  // ===========
  //
...
///////////////////////////////////////////////////////////////////////////
class GreenRocketLauncher extends RocketLauncher {
  //
  // constructor
  // ===========
  //
